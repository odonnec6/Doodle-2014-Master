...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poll.admin_hash'
        db.add_column(u'poll_poll', 'admin_hash',
                      self.gf('django.db.models.fields.CharField')(default=97, max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poll.admin_hash'
        db.delete_column(u'poll_poll', 'admin_hash')
